    ...
    <div >
      <div id="ppdf-content-page-1">
        <div style={generatingPDF ? { width: '587px', height: '842px', padding: '10px' } : null} className={`${!generatingPDF ? 'without-pdf' : null}`}>
          ...
          <h2 style={{ fontSize: '0.7rem' }}>Subject: <span style={{ fontSize: '0.7rem', marginLeft: '10px', marginTop: '4px', justifyContent: 'center', fontWeight: 'bold', textDecoration: 'underline' }} id="subject">NDMA Earthquake 2023 - Daily Situation Report</span></h2>
          <div style={{ marginTop: '0.5rem', textAlign: 'justify', fontSize: '0.6rem' }}>
            <p>NDMA Earthquake 2023 Daily Situation Report No 62, covering period from
          ...
          <div id="ppdf-content-page-2" style={generatingPDF ? { width: '587px', height: '842px', padding: '10px' } : null}>
            ...
            <p style={{fontSize: '0.6rem', margin: '0.5rem'}}>Magnitude: 6.5km</p>
            <p style={{fontSize: '0.6rem', margin: '0.5rem'}}>Depth: 6km</p>
            <p style={{fontSize: '0.6rem', margin: '0.5rem'}}>Epicenter: Hindukash</p>
            <p style={{fontSize: '0.6rem', margin: '0.5rem'}}>Originated Date: 2/12/2023</p>
            <p style={{fontSize: '0.6rem', margin: '0.5rem'}}>Originated Time: 10:23 am</p>
