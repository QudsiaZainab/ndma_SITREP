    ...
    <div >
      <div id="ppdf-content-page-1">
        <div style={generatingPDF ? { width: '587px', height: '842px', padding: '10px' } : null} className={`${!generatingPDF ? 'without-pdf' : null}`}>
          ...
          <h2 style={{ fontSize: '0.7rem' }}>Subject: <span style={{ fontSize: '0.7rem', marginLeft: '10px', marginTop: '4px', justifyContent: 'center', fontWeight: 'bold', textDecoration: 'underline' }} id="subject">NDMA Monsoon 2023 - Daily Situation Report</span></h2>
          <div style={{ marginTop: '0.5rem', textAlign: 'justify', fontSize: '0.6rem' }}>
            <p>NDMA Monsoon 2023 Daily Situation Report No 62, covering period from
